...
// const FlowCanvas: SetupFC = () => {
defineOptions({ name: 'AkirFlowCanvas' });

const { direction = 'vertical' } = defineProps<{ direction?: WFDirection }>();
const emit = defineEmits<{ zoomChanged: [value: number] }>();
const slots = defineSlots<{ default?: () => any; header?: () => any }>();
...
defineExpose({ fitViewport, initCanvasViewBox });
